...
void main() {
 testWidgets('home remains readable on a small screen with large text', (tester) async {
   sqfliteFfiInit();
   ...
   addTearDown(() async { tester.view.resetPhysicalSize(); tester.view.resetDevicePixelRatio();
     await app.close(); await db.close(); await root.delete(recursive:true); });
