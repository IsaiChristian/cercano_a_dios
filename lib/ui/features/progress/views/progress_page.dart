...
class ProgressPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(
          title: Text(AppLocalizations.of(context)!.t('milestones')),
        ),
        body: BlocBuilder<AppBloc, AppState>(
          ...
          builder: (context, _) {
            ...
            return PageBody(
              children: [
                SectionLabel(localizations.t('smallMoments')),
                Text(
                  localizations.t('progressTitle'),
                ...
                QuietCard(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        localizations.t('bestAndMoments', {
                ...
                SectionLabel(localizations.t('milestones')),
                ...badgeLabels.entries.map(
                  (badge) => ListTile(
                    ...
                    subtitle: Text(
                      progress.badges.contains(badge.key)
                          ? localizations.t('milestoneReached')
                          : localizations.t('oneMoment'),
                    ),
                  ),
                ),
                const SizedBox(height: 24),
                Text(localizations.t('progressDisclaimer')),
              ],
            );
          },
        ),
